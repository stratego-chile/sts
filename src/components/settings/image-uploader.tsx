...
type SizeUnitPrefix = 'K' | 'M'

type SizeUnitSuffix = 'B'

type FormattedSize = `${number} ${SizeUnitPrefix}${SizeUnitSuffix}`
...
const ProfileImageUploader = ({
  ...
  const validateFile = (file: RcFile) => {
    ...
    const $maxFileSizeUnit = maxFileSize.split(' ')[1] as `${SizeUnitPrefix}B`
