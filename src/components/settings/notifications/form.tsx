...
const NotificationsForm = ({
  ...
  const { handleSubmit, initialValues, isSubmitting, setValues, values } =
    useFormik<TUserNotifications>({
      initialValues: {
        ...notificationsSettings, // TODO: move spread to object bottom to update policy
        email: false,
        inApp: true,
      },
      onSubmit: () => {},
